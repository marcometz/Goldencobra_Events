Feature: Create and manage artists
  ...
  Scenario: Visit an artist and look for sponsors
    Given that a confirmed admin exists
    And I am logged in as "admin@test.de" with password "secure12"
    ...
    And I go to the admin list of artists
    When I click on "View" within "tr#artist_1"
    Then I should see "Audi Deutschland"
