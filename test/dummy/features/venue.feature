...
Scenario: Go to the venues admin site
  ...
  And I fill in "venue_location_attributes_street" with "Zossener Str."
  And I fill in "venue_location_attributes_city" with "Berlin"
  And I fill in "venue_location_attributes_zip" with "10961"
  And I fill in "venue_location_attributes_region" with "Kreuzberg"
  And I fill in "venue_location_attributes_country" with "Deutschland"
